      ...
      <q-card style="width: 70%; max-width: 80vw">
        ...
        <q-card-actions align="right" class="bg-white text-teal">
          <div class="text-right q-gutter-sm">
            <q-btn v-if="$userIsInRole('insertAttendance')&& !showId" color="primary" @click="submit"> Save </q-btn>
            <q-btn v-if="$userIsInRole('updateAttendance')&& showId" color="primary" @click="submit"> Save </q-btn>
            <q-btn v-if="showId && $userIsInRole('removeAttendance')" color="red" @click="remove"> Remove </q-btn>
